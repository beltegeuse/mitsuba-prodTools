...
def readAllTechniques(list, rep, step, uselog=False, basex="_time.csv", basey="_rmse.csv"):
    ...
    for tech in list:
        ...
        print("[READ ALL]: ", name, " time=", timename)
        ...
        if(techCurr.isValid()):
            ...
            print("WARN: Technique invalid: "+name)
    return techniques
...
if __name__=="__main__":
    ...
    if options.normalize:
        ...
        print("[INFO] Min x axis found", minX)
    ...
    print("============== Plot Techniques ... ")
    for tech in techniques:
        tech.dump()
        tech.addPlot(ax, fittingPoly, fittingClamp)
    
    print("=== Technique Order:")
    for pos,tech in enumerate(techniques):
        print("%i: Tech: %s | RMSE: %f" % (pos,tech.name,tech.y[-1]))
